...
use crate::accessibility::{Element, Rect, TreeFilter};

use super::IOSSimulatorAccessibility;
...
fn snapshot(reader: &mut IOSSimulatorAccessibility, scan: bool) -> Result<AxSnapshot> {
...
fn hit_test(
    reader: &mut IOSSimulatorAccessibility,
    x: f64,
    y: f64,
...
mod tests {
    use super::*;
    use crate::accessibility::{Point, Size};
