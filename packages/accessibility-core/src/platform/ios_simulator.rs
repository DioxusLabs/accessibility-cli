...
use accessibility_ios_sys::block2::{self, RcBlock};
use accessibility_ios_sys::objc2::runtime::{
    AnyClass, AnyObject, Bool, ClassBuilder, NSObject, Sel,
};
use accessibility_ios_sys::objc2::{self, ClassType, msg_send, sel};
use accessibility_ios_sys::objc2_core_foundation::{self, CGRect};
use accessibility_ios_sys::objc2_foundation::{NSString, NSUUID};
use accessibility_ios_sys::{libc, load_simulatorkit_framework};
...
pub fn load_frameworks() -> Result<()> {
    accessibility_ios_sys::load_frameworks()
}
